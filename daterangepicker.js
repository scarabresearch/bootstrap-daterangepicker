  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        formInputsChanged: function(e) {
            ...
            var start = moment.utc(this.container.find('input[name="daterangepicker_start"]').val(), this.locale.format).utcOffset(this.timeZone);
            var end = moment.utc(this.container.find('input[name="daterangepicker_end"]').val(), this.locale.format).utcOffset(this.timeZone);
